...
# Coordinates of points for the first set of lines
first = (
...
# Coordinates of points for the second set of lines
second = (
...
def draw_lines(draw, coordinates):
    """
    Draws lines connecting the given coordinates on the image.

    Args:
        draw (ImageDraw): An ImageDraw object to draw on.
        coordinates (tuple): A tuple containing x, y coordinates in sequence.
    """
    # Convert the tuple of coordinates into a list of tuples [(x1, y1), (x2, y2), ...]
...
def main():
    ...
    draw_lines(draw, first)
    # Draw the second set of lines
    draw_lines(draw, second)
